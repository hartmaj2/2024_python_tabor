...
score_text = Character(font.render("Score: 0",True,"Black"))
...
while True:
    for event in pygame.event.get(): # pygame.event.get() vrati seznam eventu
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if player.rect.collidepoint(last_mouse_pos):
                ...
                score += 1
                score_text.surf = font.render("Score: " + str(score),True,"Black")
    ...
    pygame.draw.aaline(screen,"Black",last_mouse_pos,pygame.mouse.get_pos(),2)
    for fly in flys:
        fly.rect.x += 10
